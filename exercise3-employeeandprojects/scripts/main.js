...
let employees = [
  ...
  function addInfo() {
    ...
    for (const employee of employees) {
        if (employee.id == id) {
        let row = employeeDataTableBody.insertRow(-1);
        let cell1 = row.insertCell(0);
        cell1.innerText = employee.name;
        let cell2 = row.insertCell(1);
        cell2.innerText = employee.jobTitle;
        let cell3 = row.insertCell(2);
        cell3.innerText = employee.yearsAtCompany;
        let cell4 = row.insertCell(3);
        cell4.innerText = employee.email;
        let cell5 = row.insertCell(4);
        cell5.innerText = employee.wfhAddress;
        let cell6 = row.insertCell(5);
        cell6.innerText = employee.skillSet;
        }
    }
}
