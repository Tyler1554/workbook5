...
const selectEmployeeDrop = document.querySelector("#selectEmployeeDrop");
...
function loadEmployeeList() {
  for (const employee of employees) {
    ...
    selectEmployeeDrop.appendChild(option);
  }
}
...
function addInfo() {
  ...
  for (const employee of employees) {
    ...
    if (employee.id == id) {
      let row = employeeDataTableBody.insertRow(0);
      row.innerText = employee.name;
      let row2 = employeeDataTableBody.insertRow(1);
      row2.innerText = employee.jobTitle;
      let row3 = employeeDataTableBody.insertRow(2);
      row3.innerText = employee.yearsAtCompany;
      let row4 = employeeDataTableBody.insertRow(3);
      row4.innerText = employee.email;
      let row5 = employeeDataTableBody.insertRow(4);
      row5.innerText = employee.wfhAddress;
      let row6 = employeeDataTableBody.insertRow(5);
      row6.innerText = employee.skillSet;
      let row7 = employeeDataTableBody.insertRow(6);
      row7.innerText = number.length;
    }
  }
}
